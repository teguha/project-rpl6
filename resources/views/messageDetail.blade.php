                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <form class="form-horizontal form-material mx-2">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="message" class="col-md-12 mb-0" >Message</label>
                                                              <input id="message" type="hidden" name="message" value="{{$message->message}}">
                                                                <trix-editor input="message" ></trix-editor>
                                                            </div>
                                                            <a type="button" class="btn btn-info mt-3" href="{{route('message-user')}}">Kembali</a>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>

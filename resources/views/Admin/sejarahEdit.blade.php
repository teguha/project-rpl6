            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{route('Sejarah-edit-saves',$sejarah->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                            ...
                                            <div class="card-body">
                                                <form class="form-horizontal form-material mx-2">
                                                    <div class="form-group">
                                                        <label class="col-md-12 mb-0" for="nama" entype="file">Judul</label>
                                                        <div class="col-md-12">
                                                            <input type="text" placeholder=""
                                                                class="form-control ps-0 form-control-line @error ('judul') is-invalid @enderror" id="judul" name="judul"  value="{{$sejarah->judul}}" autofocus>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" class="form-control-file" id="foto" name="foto">
                                                            <img src="{{ URL::to('/') }}/foto/{{ $sejarah->gambar }}" class="img-thumbnail" width="200px"/>
                                                        <input type="hidden" class="form-control" id="hidden_image" name="hidden_image" value="{{$sejarah->gambar}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="konten" class="col-md-12 mb-0" >Konten</label>
                                                            <input id="konten" type="hidden" name="konten" value="{{$sejarah->konten}}">
                                                            <trix-editor input="konten"></trix-editor>
                                                        </div>
                                                    <div>
                                                    <button type="submit" class="btn btn-success mt-3">Simpan</button>
                                                    <a type="button" class="btn btn-info mt-3" href="{{route('Sejarah-user')}}">Kembali</a>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
